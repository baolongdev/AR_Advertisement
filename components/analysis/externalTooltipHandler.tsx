...
const getOrCreateLine = (chart) => {
    let lineEl = chart.canvas.parentNode.querySelector('div.line');
    if (!lineEl) {
        lineEl = document.createElement('div');
        lineEl.className = 'line'; // Đặt class cho phần tử div
...
export const externalTooltipHandler = (context) => {
    ...
    const { offsetLeft: positionX, offsetTop: positionY, offsetHeight: height } = chart.canvas;
    lineEl.style.height = height - 12 + 'px';
